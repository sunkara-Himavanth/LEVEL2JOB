        ...
        <table className='min-w-full bg-white border border-gray-200 max-sm:text-sm'>
          <thead>
            <tr className='border-b'>
              ...
              <th className='py-2 px-4 text-center'>Application</th>
          ...
          <tbody>
            {manageJobsData.map((job,index) =>(
              <tr key={index} className='text-gray-700'>
                <td class="py-2 px-4 border-b max-sm:hidden">{index+1}</td>
                <td class="py-2 px-4 border-b">{job.title}</td>
                <td class="py-2 px-4 border-b max-sm:hidden">{moment(job.date).format('ll')}</td>
                <td class="py-2 px-4 border-b max-sm:hidden">{job.location}</td>
                <td class="py-2 px-4 border-b">{job.applicants}</td>
